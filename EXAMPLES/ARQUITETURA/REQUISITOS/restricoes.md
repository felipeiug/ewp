...
- Registrar versões das ferramentas, unidades, escala, revisão e data de cada entrega oficial.
- Respeitar e alegar ao responsável qualquer incosistência ao plano diretor da cidade.
- O responsável deve revisar e aprovar as decisões de projeto antes da emissão final.
